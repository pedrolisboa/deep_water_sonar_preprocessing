...
print(os.environ)
EXPERIMENT_NAME = 'sacred-initial-experiment'
...
class Trainer:
    ...
    def get_datasets(self):
        train_dataset = torchvision.datasets.MNIST(root='../../data/raw', train=True, transform=transforms.ToTensor(),
                                                   download=True)

        test_dataset = torchvision.datasets.MNIST(root='../../data/raw', train=False, transform=transforms.ToTensor())
...
def main(_run):
    ...
    _run.log_scalar('accuracy', float(accuracy))  # SACRED: Keep track of the loss
